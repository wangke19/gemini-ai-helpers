...
gemini mcp add --transport sse atlassian http://localhost:8080/sse
```
...
This plugin uses shared reference files for progressive disclosure, following [Gemini CLI best practices](https://cloud.google.com/gemini/docs/extensions/best-practices).
