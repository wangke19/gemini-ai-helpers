...
5. **PR Creation**: 
   ...
   - Create pull request with:
     ...
     - The "🤖 Generated with Gemini CLI" sentence should include a reference to the slash command that triggered the execution, for example "via `/jira-solve OCPBUGS-12345 enxebre`"
