...
Follow the skill documentation in `extensions/jira/skills/status-analysis/`:
...
2. Comment includes footer: `_Generated with [Gemini CLI|https://claude.com/claude-code] via {{/jira:status-rollup {issue-id} --start-date {date} --end-date {date}}}_`
