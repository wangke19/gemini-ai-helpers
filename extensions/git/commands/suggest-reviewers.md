...
**IMPORTANT: Use the helper script** `${GEMINI_EXTENSION_ROOT}/skills/suggest-reviewers/analyze_blame.py` to perform this analysis. Do NOT implement this logic manually.
...
## Return Value
- **Gemini agent text**: Formatted list of suggested reviewers including:
