...
**Skill Reference:**
- Implementation: `extensions/openshift/skills/openshift-node-kernel/node-kernel-conntrack.sh`
- Helper functions: `extensions/openshift/skills/openshift-node-kernel/kernel-helper.sh`
- Documentation: `extensions/openshift/skills/openshift-node-kernel/SKILL.md`
