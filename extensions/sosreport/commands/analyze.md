...
**Detailed implementation**: See `extensions/sosreport/skills/logs-analysis/SKILL.md`
...
**Detailed implementation**: See `extensions/sosreport/skills/resource-analysis/SKILL.md`
...
**Detailed implementation**: See `extensions/sosreport/skills/network-analysis/SKILL.md`
...
**Detailed implementation**: See `extensions/sosreport/skills/system-config-analysis/SKILL.md`
...
### Analysis Skills
- **Logs Analysis**: `extensions/sosreport/skills/logs-analysis/SKILL.md` - Detailed guidance for analyzing system and application logs
- **Resource Analysis**: `extensions/sosreport/skills/resource-analysis/SKILL.md` - Detailed guidance for analyzing memory, CPU, disk, and processes
- **Network Analysis**: `extensions/sosreport/skills/network-analysis/SKILL.md` - Detailed guidance for analyzing network configuration and connectivity
- **System Configuration Analysis**: `extensions/sosreport/skills/system-config-analysis/SKILL.md` - Detailed guidance for analyzing packages, services, and security settings
