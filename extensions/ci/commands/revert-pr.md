...
3. **Perform the Revert**: Use the `revert-pr` skill
   ...
   Follow the complete workflow in `extensions/ci/skills/revert-pr/SKILL.md`, which covers:
...
- Related Skill: `revert-pr` - Detailed git revert workflow and PR template (`extensions/ci/skills/revert-pr/SKILL.md`)
