...
2. **Fetch Jira Issue**: Read the bug description, status, and comments
   ...
   See `extensions/ci/skills/fetch-jira-issue/SKILL.md` for complete implementation details including error handling.
...
- Related Skill: `fetch-regression-details` (`extensions/ci/skills/fetch-regression-details/SKILL.md`)
- Related Skill: `fetch-test-report` (`extensions/ci/skills/fetch-test-report/SKILL.md`)
- Related Skill: `fetch-test-runs` (`extensions/ci/skills/fetch-test-runs/SKILL.md`)
- Related Skill: `fetch-releases` (`extensions/ci/skills/fetch-releases/SKILL.md`)
- Related Skill: `list-regressions` (`extensions/teams/skills/list-regressions/SKILL.md`)
