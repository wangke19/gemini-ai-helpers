...
7. **Offer HTML Report Generation** (AFTER displaying the text report):
   ...
   - Use template from: `extensions/teams/skills/analyze-regressions/report_template.html`
...
- Skill Documentation: `extensions/teams/skills/analyze-regressions/SKILL.md`
